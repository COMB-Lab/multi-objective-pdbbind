"""
PyTorch training script for PGGCN model - Modified for configurable dataset size
...
- All other model features preserved (L2 regularization, MaxNorm, etc.)
"""
...
def main():
    print("=" * 80)
    print("PyTorch PGGCN Training - Configurable Dataset Size")
    print("=" * 80)
    ...
    print("Saving Model")
    print("-" * 80)
    model_path = f'/home/exouser/multi-objective-pdbbind/multi-objective-pdbbind/pytorch-implementation/saved_models/{MAX_SAMPLES}structures.pth'

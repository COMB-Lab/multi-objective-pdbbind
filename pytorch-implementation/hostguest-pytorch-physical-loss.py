...
class PhysicsInformedLoss(nn.Module):
    ...
    Loss = MSE(prediction, target) + physics_weight * physics_consistency_loss
    """
    ...
    def forward(self, predictions, targets, model_vars, physics_info):
        ...
        mse_loss = torch.sqrt(self.mse(predictions, targets))  # RMSE
        # Extract energies
        ...
        # Physics consistency loss (RMSE between model prediction and physics calculation)
...
def featurize(molecule, info):
    ...
    for atom in molecule.GetAtoms():
        ...
        # Pad if less than 2 neighbors (use 0.0 as padding)
...
def train_model(model, X_train, y_train, X_val, y_val, epochs=100, lr=0.005, device='cpu',
                physics_consistency_weight=0.005, monitor=None, l2_weight=1e-4, dropout_rate=0.2, max_norm=3.0):
    """
    ...
    Args:
        ...
        physics_consistency_weight: Weight for physics consistency loss
    ...
    print(f"Physics consistency weight: {physics_consistency_weight}")
    ...
    for epoch in range(epochs):
        ...
        train_physics_losses.append(train_physics_loss.item())
        ...
        if (epoch + 1) % 10 == 0 or epoch == 0:
            ...
            output = (f"Epoch {epoch+1:3d}/{epochs} | "
                     ...
                     f"Phys: {train_physics_loss.item():.4f}) | "
...
def main():
    ...
    print("Saving Model")
    print("-" * 80)
    model_path = '/home/exouser/multi-objective-pdbbind/multi-objective-pdbbind/pytorch-implementation/saved_models/hostguest_model_weight_58.pth'
